          ...
          <div class="col-md-12">
            <form class="form-horizontal form-groups" method="post"
              ...
              <div class="form-group">
        				...
        				<div class="col-sm-5">
        					<input type="text" class="form-control" name="name" placeholder="Download from scriptzhub.com" required>
        				</div>
                <div class="col-sm-4" style="font-size: 12px;">
              ...
              <div class="form-group">
        				...
        				<div class="col-sm-5">
        					<input type="email" class="form-control" name="email" placeholder="Download from scriptzhub.com" required>
        				</div>
                <div class="col-sm-4" style="font-size: 12px;">
              ...
              <div class="form-group">
        				...
        				<div class="col-sm-5">
        					<input type="password" class="form-control" name="password" placeholder="Download from scriptzhub.com"
                    required>
        				</div>
                <div class="col-sm-4" style="font-size: 12px;">
